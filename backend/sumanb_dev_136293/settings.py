"""
Django settings for sumanb_dev_136293 project.
...
ROOT_URLCONF = 'sumanb_dev_136293.urls'
...
WSGI_APPLICATION = 'sumanb_dev_136293.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "sumanB Support <support@sumanb-dev-136293.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sumanb_dev_136293 API",
    "DESCRIPTION": "API documentation for sumanb_dev_136293 App",
    "VERSION": "v1",
}
